    ...
    return (
        <div id="art">
            <div className="contianer mx-auto h-full md:pt-20 pt-10">
                <h2 className="will-fade">VIRASAT</h2>
                ...
                <div className="masked-container">
                    <div id="masked-content" className="md:mt-0 -mt-2.5" >
                        <h3>
                            Prepared with Heritage, Served with Pride
                        </h3>
                        <p>This isn't just a meal. It's a timeless tradition brought to life, honoring generations of royal kitchens and authentic Rajasthani flavors.</p>
                    </div>
                </div>
            </div>
        </div>
